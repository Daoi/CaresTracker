<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CapstoneUI.Master" CodeBehind="CHWInteractionList.aspx.cs" Inherits="CapstoneUI.CHWInteractionList" %>
        ...
        <div class="container-fluid pl-5 pr-5">
            <div class="table-responsive tableContainer" style="background-color: white !important">
                ...
                <div class="container-fluid mt-2">
                    <asp:GridView ID="gvInteractionList" Width="100%" runat="server" AutoGenerateColumns="False" CssClass="table table-light table-striped table-bordered thead-dark" OnRowCommand="gvInteractionList_RowCommand">
                        <Columns>
