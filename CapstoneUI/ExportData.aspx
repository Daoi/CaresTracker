            ...
            <div class="card-body justify-content-center">
                ...
                <div class="form-group row justify-content-center">
                    <div class="col-md-6 text-secondary">
                        ...
                        Initial Date:<br />
                        <asp:TextBox ID="txtDateInitial" TextMode="DateTimeLocal" runat="server"></asp:TextBox><br />
                        Final Date:<br />
                        <asp:TextBox ID="txtDateFinal" TextMode="DateTimeLocal" runat="server"></asp:TextBox><br />
                    </div>
                </div>
                <asp:Button ID="btnSubmitImport" runat="server" Text="Generate Report" CssClass="btn-primary btn-lg" />
            </div>
