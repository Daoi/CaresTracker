...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid p-0 homepage backgroundblue">
        <h3 class="modal-header">Event Details</h3>
        <%-- Section 1 Start --%>
        <div class="eventContainer">
            <div class="row form-inline form-group no-gutters">
                <div class="col-md-1 col-sm-1"></div>
                <div class="col-md-4 quickAccess col-sm-1">
                    <h3><asp:Label ID="lblEventName" runat="server" Text="The Importance of Masks"></asp:Label></h3>
                    <br />
                    <span><b>Type:</b>
