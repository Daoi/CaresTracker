<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InteractionForm.aspx.cs" Inherits="CapstoneUI.InteractionForm" %>
            ...
            <div id="logo">
                ...
                <div class="rightbox">
                    ...
                    <div id="otherForm" class="otherInfo" runat="server">
                        ...
                        <h2>Next Steps:</h2>
                        <textarea id="nextSteps" name="nextSteps" rows="5" cols="70">
                            We should try establishing contact with Jane Smith and John Doe.
                            </textarea>
                    </div>
                    <%-- Other Form End --%>
                </div>
