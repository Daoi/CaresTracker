...
{
    public class GetTotalGenderReport : DataSupport, IData
    {
        public GetTotalGenderReport()
        {
            CommandText = "R_GetTotalGenderReport";
            CommandType = CommandType.StoredProcedure;
        }

        /// <summary>
        /// Gets the number of residents per gender at this development
        /// </summary>
