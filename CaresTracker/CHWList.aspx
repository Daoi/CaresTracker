    ...
    <div class="container-fluid homepage">
        ...
        <div class="table-responsive tableContainer">
            <div class="container-fluid mt-2">
                ...
                <asp:GridView ID="gvCHWList" Width="100%" runat="server" AutoGenerateColumns="False" CssClass="table table-light table-striped table-bordered thead-dark gvBtn">
                    <HeaderStyle CssClass="cherryBackground" />
                    <Columns>
                        <asp:TemplateField HeaderText="View">
                            <ItemTemplate>
                                <asp:Button ID="btnViewWorker" CssClass="btn btn-light w-100 font-weight-bold" runat="server" Text="View" OnClick="btnViewWorker_Click" />
                            </ItemTemplate>
                        </asp:TemplateField>
